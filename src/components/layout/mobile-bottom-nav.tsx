...
export function MobileBottomNav({ onMenuToggle }: MobileBottomNavProps) {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 bg-background/90 backdrop-blur-xl border-t border-border/50 py-1.5 px-3 lg:hidden shadow-[0_-4px_20px_rgba(0,0,0,0.1)] flex items-center justify-around">
